...
const TaskDetails = () => {
    ...
    const fetchComments = async () => {
        ...
        try {
            const { data } = await api.get(`/api/comments/${taskId}`, { headers: { Authorization: `Bearer ${await getToken({ skipCache: true })}` } })
    ...
    const handleAddComment = async () => {
        ...
        try {
            ...
            const { data } = await api.post('/api/comments', { taskId: task.id, content: newComment }, { headers: { Authorization: `Bearer ${await getToken({ skipCache: true })}` } })
