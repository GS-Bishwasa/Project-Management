...
const ProjectTasks = ({ tasks }) => {
    ...
    const handleStatusChange = async (taskId, newStatus) => {
        try {
           ...
           await api.put(`/api/tasks/${taskId}`, {status: newStatus}, {headers: { Authorization: `Bearer ${await getToken({ skipCache: true })}` }})
    ...
    const handleDelete = async () => {
        try {
            ...
            await api.post('/api/tasks/delete', {tasksIds: selectedTasks}, {headers: { Authorization: `Bearer ${await getToken({ skipCache: true })}` }})
